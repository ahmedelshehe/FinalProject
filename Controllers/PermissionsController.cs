...
namespace FinalProject.Controllers
{
    public class PermissionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Operation")] Permission permission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Operation")] Permission permission)
        {
            if (id != permission.Id)
            {
                return NotFound();
