...
namespace FinalProject.ViewModels
{
	public class EmployeeDashboardVM
	{
		...
		public EmployeeDashboardVM(List<Attendance> attendances, Employee employee , IVacationRepository VactionRepository)
		{
		...
		public int ThisMonthWorkDaysUntilToday { get {
		...
		public int ThisMonthExtraHours { get { 
